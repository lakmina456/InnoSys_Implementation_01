...
def process_video_realtime(input_video_path, output_video_path):
    ...
    while cap.isOpened():
        ...
        # cv2.putText(frame, f"Blurry Appear: {is_blurry}", (10, 110), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
...
if __name__ == "__main__":
    process_video_realtime('4.mp4', 'output4.mp4')
